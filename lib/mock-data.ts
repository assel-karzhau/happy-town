...
export const words = [
  ["family", "семья", "My Family", "Unit 3", "15 мая 2025", "Освоено"], ["mother", "мама", "My Family", "Unit 3", "15 мая 2025", "Уверенно использует"],
  ["brother", "брат", "My Family", "Unit 3", "15 мая 2025", "Изучает"], ["train", "поезд", "My Toys", "Unit 2", "8 мая 2025", "Нужно повторить"],
  ["pencil case", "пенал", "At School", "Unit 2", "1 мая 2025", "Освоено"], ["classroom", "класс", "At School", "Unit 2", "1 мая 2025", "Новое"],
];

export const tests = [
  ["Unit 2 Test", "Unit 2", "12 мая 2025", "41", "50", "82%", "Сильный словарный запас", "Проверено"],
  ["Unit 1 Test", "Unit 1", "28 апр 2025", "38", "50", "76%", "Повторить письменную часть", "Проверено"],
  ["Starter Test", "Starter", "10 апр 2025", "34", "50", "68%", "Хорошая база для старта", "Проверено"],
];

export const homework = [
  ["16 мая", "19 мая", "Family and Friends 1", "24", "2–3", "Составить 5 предложений о семье", "Материал не прикреплён", "Выполнено"],
  ["14 мая", "16 мая", "Family and Friends 1", "22", "1", "Подписать школьные предметы", "Учитель: аккуратная работа", "Проверено"],
  ["9 мая", "12 мая", "Family and Friends 1", "18", "4", "Повторить слова по теме My Toys", "Учитель: повторить train и kite", "Нужно повторить"],
];
